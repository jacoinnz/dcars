...
export const students = pgTable(
  "students",
  {
    ...
    /** Labels captured at admission (may differ from enrolled `classes` membership). */
    academicYear: text("academic_year"),
    admissionClassLabel: text("admission_class_label"),
    admissionSectionLabel: text("admission_section_label"),
    ...
    /** Body measurements as entered (e.g. inches / kg). */
    heightIn: text("height_in"),
    weightKg: text("weight_kg"),
    /** Optional portrait URL when not storing a file blob. */
    ...
    previousSchoolDateLeft: date("previous_school_date_left", { mode: "string" }),
    previousSchoolLeavingReason: text("previous_school_leaving_reason"),
    /** Free-form block for prior institution (eSkooly-style single field); structured columns may be null for new admits. */
    ...
    guardianName: text("guardian_name"),
    /** When `guardian_relation_kind` is `other`, free-text relationship (e.g. grandparent). */
    guardianRelationship: text("guardian_relationship"),
    /** `father` | `mother` | `other` — who acts as guardian for contact purposes. */
    guardianRelationKind: text("guardian_relation_kind"),
    guardianPhone: text("guardian_phone"),
    guardianEmail: text("guardian_email"),
    ...
    documentAttach1Title: text("document_attach_1_title"),
    documentAttach1Url: text("document_attach_1_url"),
    documentAttach2Title: text("document_attach_2_title"),
    documentAttach2Url: text("document_attach_2_url"),
    documentAttach3Title: text("document_attach_3_title"),
    documentAttach3Url: text("document_attach_3_url"),
    documentAttach4Title: text("document_attach_4_title"),
    documentAttach4Url: text("document_attach_4_url"),
    /** Transport / hostel (eSkooly-style Other Info tab). */
    transportRouteList: text("transport_route_list"),
    transportVehicleNumber: text("transport_vehicle_number"),
    dormitoryName: text("dormitory_name"),
    dormitoryRoomNumber: text("dormitory_room_number"),
    admissionNotes: text("admission_notes"),
